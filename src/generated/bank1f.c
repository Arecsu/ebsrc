...
// ⏳ bankconfig/common/bank1f.asm → Pending conversion
...
/*
 * Build Instructions:
 * cc65 src/generated/bank1f.c --code-name BANK1F -o build/bank1f.o
 */
