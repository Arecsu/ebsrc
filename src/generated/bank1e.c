...
// ⏳ bankconfig/common/bank1e.asm → Pending conversion
...
/*
 * Build Instructions:
 * cc65 src/generated/bank1e.c --code-name BANK1E -o build/bank1e.o
 */
