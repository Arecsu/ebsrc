...
// ⏳ bankconfig/common/bank0a.asm → Pending conversion
...
/*
 * Build Instructions:
 * cc65 src/generated/bank0a.c --code-name BANK0A -o build/bank0a.o
 */
