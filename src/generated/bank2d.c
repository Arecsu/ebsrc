...
// ⏳ bankconfig/common/bank2d.asm → Pending conversion
...
/*
 * Build Instructions:
 * cc65 src/generated/bank2d.c --code-name BANK2D -o build/bank2d.o
 */
